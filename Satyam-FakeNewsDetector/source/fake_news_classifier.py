...
numeric_data,textual_data,labels = get_data("/home/vishalkharde/Downloads/Fake News Projects/ADAFake-master/data/electionday_tweets_clean.xlsx")


# in process
# Remove punctuation and unknown characters, convert all text to lower case
path = "/home/vishalkharde/Downloads/Fake News Projects/ADAFake-master/data/electionday_tweets_clean.xlsx"
original_data = pd.read_excel(path, header=0)
...
print("inside fake news classifier")
